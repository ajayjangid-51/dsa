...
Node *Tree::generateFromTraversal(int *inorder, int *preorder, int inStart, int inEnd)
{
    ...
    static int preIndex = 0; // static-variable ka assignation sirf ek hi baar hota hai baki updation toh hota hi hai.
    ...
    // for post-order start to taking elements from reverse..
